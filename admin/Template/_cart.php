            ...
            <?php
              ...
              ?>
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="images/<?php echo $fetch_cart['image']; ?>" style="height: 120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <form method="post">
                                ...
                                <a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn btn-success" onclick="return confirm('remove item from cart?');">Delete</a>
                            </form>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn btn-warning mt-3 <?php echo ($grand_total > 1)?'':'disabled'; ?>">Proceed to Buy</button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
