...
function chatHeartbeat(){
	...
	jQuery.ajax({
	  url: "http://mysite.com/codeigniter_project/app/views/chat/chat.php?action=chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	jQuery.post("http://localhost/code/application/views/chat/chat.php?action=closechat", { chatbox: chatboxtitle} , function(data){	
	});
