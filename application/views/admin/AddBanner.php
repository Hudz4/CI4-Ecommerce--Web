      ...
      <div class="col-md-6 col-md-offset-2">
        <div class="card shadow-lg mx-auto" style=" background-color: white;">
            <div class="card-header" style="background-color:var(--secondary);">
                  	<h2 class="box-title  mt-2" style="color:white">Add Banner</h2>
            </div>
            <div class="card-body"  >
              <?php echo form_open_multipart('admin/addBan','','') ?>
                  <div class='row'>
                          ...
                          ?>
                            ...
                            <div class='file-field input-field col s12'>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('name','','type="text" class="form-control" ') ?>
                                </div>
              ...
              <div class="card-footer">
                <button type='submit' name='btn_add_brnd' class='btn btn-success'>Add Banner</button>
