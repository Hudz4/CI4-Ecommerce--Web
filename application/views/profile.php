...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        ...
        <input class="checkbox mt-3" type="checkbox" onchange="toggleDisable(this);" id="check"> 
            Enable Profile Edit
        ...
        <div class="col-md-4">
            <input class="checkbox mt-3" type="checkbox" onchange="toggleDisable2(this);" id="check2"> 
            Enable Account Edit
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td >
                            ...
                            <a href="<?php echo site_url('home/profile/'.$list->id).'.is.Deleted'?>" class="close delord" data-id="<?php echo $list->id; ?>"  data-text="<?php echo $this->encryption->encrypt($list->id) ?>">&times;</a>
                            <?php endif; ?>
